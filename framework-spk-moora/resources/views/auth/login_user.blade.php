    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <img src="{{ asset('img/logo.png') }}" alt="Sekolah">
            ...
            @endif
            <form class="form-signin user" method="post" action="{{ route('login-user.submit') }}">
              @csrf
              ...
              <a class="btn btn-lg btn-success btn-block text-uppercase shadow" href="{{ route('login-admin') }}">Masuk sebagai Pegawai</a>
            </form>
          </div>
        </div>
      </div>

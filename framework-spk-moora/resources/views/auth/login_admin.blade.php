      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            @endif
            <form class="form-signin user" method="post" action="{{ route('login-admin.submit') }}">
              @csrf
              ...
              <a class="btn btn-lg btn-success btn-block text-uppercase shadow" href="{{ route('login-user') }}">Masuk sebagai Guru</a>
            </form>
          </div>
        </div>
      </div>

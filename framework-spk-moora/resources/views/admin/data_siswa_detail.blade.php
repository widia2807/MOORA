          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-lg-6 col-xl-6" style="text-align: right;">
                <a class="btn btn-outline-dark font-weight-bold" href="/admin/data-siswa"><span class="icon "><i class="fas fa-arrow-left mr-lg-2"></i>Kembali</a>
                <a class="btn btn-outline-primary font-weight-bold" href="/admin/data-siswa/{{ $dataSiswa->id_siswa }}/edit">
                  <span class="icon"><i class="fas fa-edit mr-lg-2"></i></span>Ubah Data Siswa
                </a>
              </div>
            </div>
          </div>

        ...
        <div class="container">
            <div class="col-xl-12 col-lg-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form class="form" method="post" name="converter" action="{{ route('registrasi-guru.store') }}">
                            @csrf
                            <div class="form-group">
                                <label class="control-label col-md-12 col-sm-12 col-xs-12">ID Account</label>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input class="form-control" type="text" name="id_user" value="{{ $idUser }}" readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group">
